<template>
  <b-overlay :show="show">
            ...
            <b-col lg="3" sm="12" class="achievement-input">
              <div class="mr-2">
                ...
                <v-select
                  ...
                  class="fname-select select-overflow"
                ></v-select>
              </div>
            </b-col>
    ...
    <b-row class="mt-2">
      <b-col>
        <device-log-info :devicelog="devicelog"></device-log-info>
      </b-col>
    </b-row>
    <b-row class="mt-1">
      <b-col>
...
import DeviceLogInfo from "@/components/DeviceLogInfo";
...
export default {
  components: { CustomDatePicker,DeviceLogInfo },
  watch: {
  ...
  created() {
    ...
    this.show = true;
    PersonMemberService.Get(this.$route.params.id).then((res) => {
      this.show = false;
      this.PersonMember = res.data;
      this.devicelog = res.data.TourniquetDeviceCompareLog
  ...
  methods: {
    ...
    check() {
      ...
      // if (
      //   this.PersonMember.inn === 0 ||
      //   this.PersonMember.inn === null ||
      //   this.PersonMember.inn === undefined ||
      //   this.PersonMember.inn === ""
      // ) {
    ...
    SearchPerson() {
      ...
      PersonMemberService.GetFromGovDataForPersonMember(
        ...
        .then((res) => {
          ...
          this.PersonMember.identitydocumentid = res.data.DocumentTables[0].identitydocumentid;
          this.PersonMember.identitydocumentname =
            res.data.DocumentTables[0].identitydocumentname;
          this.PersonMember.documentseries = res.data.DocumentTables[0].documentseries;
          this.PersonMember.documentnumber = res.data.DocumentTables[0].documentnumber;
          this.PersonMember.dateofissue = res.data.DocumentTables[0].dateofissue;
          this.PersonMember.dateofexpire = res.data.DocumentTables[0].dateofexpire;
          this.PersonMember.issueorganization = res.data.DocumentTables[0].issueorganization;
    ...
    SaveData() {
      ...
      PersonMemberService.Update(this.PersonMember)
        .then((res) => {
          ...
          this.$router.push({ name: "PersonMember" });
        })
        .catch((err) => {
          this.makeToast(
