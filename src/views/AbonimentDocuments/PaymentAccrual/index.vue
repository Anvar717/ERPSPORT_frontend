  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("PaymentAccrual") }}</h3>
        <CCardHeader>
...
export default {
    ...
    return {
      fields: [
        ...
        },
        {
          ...
          tdClass: "text-center",
          thClass: "text-center",
          label: this.$t("docmonth"),
          sortable: false,
        },
        // {
        //   key: "circlesporttypename",
        //   tdClass: "text-left",
        //   thClass: "text-center",
  ...
  methods: {
    ...
    Delete(item) {
      PaymentAccrualService.Delete(item.id)
        .then((res) => {
          this.makeToast(
    ...
    Approve(item) {
      var self = this;
      PaymentAccrualService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      PaymentAccrualService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
