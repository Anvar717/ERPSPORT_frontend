    ...
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <b-row class="mt-3 mx-1">
          <b-col lg="12">
            <h3 class="text-center">{{ $t("TreasBankDocument") }}</h3>
          </b-col>
        ...
        <CCardHeader>
          <!-- <CRow>
            <CCol lg="3" md="2" class="text-left">
            ...
            <CCol lg="6" md="2" sm="11" class="text-left d-flex align-items-center">
              <div>
          ...
          <b-row>
            ...
            <b-col lg="3" md="2" class="achievement-input">
              <label class="col-form-label"> {{ $t("region") }} </label>
              <v-select
                :options="RegionList"
                v-model="filter.regionid"
            ...
            <b-col lg="6" sm="12" class="d-flex align-items-center flex-wrap w-100">
              <div class="">
                <label for="#">{{ $t("Search") }}</label>
                <CInput
                  :placeholder="$t('search')"
...
export default {
  ...
  methods: {
    Print() {
      ...
      TreasBankDocumentService.PrintReportTreasBankDocument(
        ...
        .then((res) => {
          ...
          this.forceFileDownload(res, "ReportTreasBankDocument");
        })
        .catch((err) => {
          this.PrintLoading = false;
