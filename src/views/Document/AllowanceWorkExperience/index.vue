        ...
        <CCardHeader>
          <CRow class="form-group">
            ...
            <CCol lg="7" md="6" sm="12" class="text-lg-right mt-2">
              <CButton
                v-if="$can('AllowanceWorkExperienceEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
          ...
          >
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-link
                  v-if="$can('AllowanceWorkExperienceDelete', 'permissions')"
                ...
                <b-link
                  v-if="$can('AllowanceWorkExperienceAccept', 'permissions')"
                ...
                <b-link
                  v-if="$can('AllowanceWorkExperienceCancel', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      AllowanceWorkExperienceService.Delete(item.id)
        .then((res) => {
          this.makeToast(
    ...
    Approve(item) {
      var self = this;
      AllowanceWorkExperienceService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      AllowanceWorkExperienceService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
            self.$t("AcceptMessage"),
            self.$t("message"),
    ...
    Refresh() {
      this.isBusy = true;
      AllowanceWorkExperienceService.GetList(
        this.filter.Search,
