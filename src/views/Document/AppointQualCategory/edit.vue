    ...
    <CCol>
      <CCard accent-color="primary" class="pb-4">
        <CCardHeader>
          <CRow>
            <CCol>
              <h4 class="text-center">{{ $t("AppointQualCategory") }}</h4>
            </CCol>
          </CRow>
        </CCardHeader>
        <CCardBody>
          ...
          <CCol>
            <div class="text-left">
              <CButton
                ...
                size="sm"
                color="danger"
                @click="$router.push({ name: 'AppointQualCategory' })"
              >
...
export default {
  ...
  methods: {
    ...
    SaveData() {
      ...
      this.AppointQualCategory.qaulcategorytypeid = 1
      AppointQualCategoryService.Update(self.AppointQualCategory)
        .then((res) => {
          ...
          self.$router.push({ name: "AppointQualCategory" });
        })
        .catch((error) => {
          self.makeToast(
