  ...
  <b-overlay :show="previewshow">
    <b-row>
      <b-col cols="12" :md="10">
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="pb-1">
                          <span class="font-weight-bold">
                            {{AppointQualCategory.sporttypeclassifiername }}
                          </span>
                        </td>
                      </tr>
                        <tr>
                ...
                <b-col cols="12" md="6">
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td class="pr-1 pb-1 mt-2">{{ $t("SportQualSpecialTy") }} :</td>
                        <td class="font-weight-bold pb-1">
                          {{ AppointQualCategory.sportqualspecialtyname }}
                        </td>
                      </tr>
                       <tr>
                    ...
                    <td>
                      <b-badge
                        :variant="
                         getItemColor(AppointQualCategory.statusname)
                        "
                      >
                        {{ AppointQualCategory.statusname }}
                      </b-badge>
                    </td>
                  </tr>
                    </tbody>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <b-badge
                        :variant="
                          AppointQualCategory.statusname == 'Утвержден'
                            ? 'success'
                            : AppointQualCategory.statusname == 'Отправлен'
                            ? 'info'
                            : AppointQualCategory.statusname == 'Создан' ||
                              AppointQualCategory.statusname == 'Изминен' ||
                              AppointQualCategory.statusname == 'Изменен'
                            ? 'primary'
                            : 'danger'
                        "
                      >
        ...
        <b-row>
          <b-col sm="12" md="12">
            <b-card>
              <history-detail-info
                :history="AppointQualCategory.History"
              ></history-detail-info>
            </b-card>
          </b-col>
        </b-row>
      ...
      <b-col cols="12" md="2">
        ...
        <b-button
          v-if="
            $can('AppointQualCategorySportApprove', 'permissions') &&
            AppointQualCategory.CanApprove
          "
        ...
        <b-button
          v-if="
            $can('AppointQualCategorySportCancelApproval', 'permissions') &&
            AppointQualCategory.CanCancelApprove
          "
        ...
        <b-button
          v-if="
            $can('AppointQualCategorySportSent', 'permissions') &&
            AppointQualCategory.CanSend
          "
      ...
      <b-modal :ref="'ApproveModal'" no-close-on-backdrop hide-footer>
        ...
        <b-row class="mt-2">
          <b-col>
            ...
            <b-form-input
              ...
              v-model="ApproveData.documentnumber"
            ></b-form-input>
          </b-col>
        </b-row>
        <b-card-text class="mt-3">
          ...
          <span>
            <h5>
              {{ $t("name") }} : {{ AppointQualCategory.personname }}
            </h5></span
          >
          <h5>{{ $t("WantApprove") }}</h5>
        </b-card-text>
      ...
      <b-modal :ref="'CancelApprovalModal'" hide-footer no-close-on-backdrop>
        ...
        <b-row class="mt-2">
          <b-col>
            ...
            <b-form-input
              :placeholder="$t('docnumber')"
              v-model="CancelApproveData.documentnumber"
            ></b-form-input>
          </b-col>
        </b-row>
        <b-row class="mt-2">
          <b-col>
            ...
            <b-form-textarea
              v-model="CancelApproveData.returnReason"
            ></b-form-textarea>
          </b-col>
        </b-row>
        <b-card-text class="mt-3">
