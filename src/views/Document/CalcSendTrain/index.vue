  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("CalcSendTrain") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            <CCol lg="7" md="6" sm="12" class="text-lg-right mt-2">
              <CButton
                v-if="$can('CalcSendTrainEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
          ...
          >
            ...
            <template v-slot:head(employeeenrolmentid)>
              ...
              >
                ...
                <b-icon v-if="filter.SortColumn === 'employeeenrolmentid'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-link
                  v-if="$can('CalcSendTrainDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      CalcSendTrainService.Delete(item.id)
        .then((res) => {
          this.makeToast(
