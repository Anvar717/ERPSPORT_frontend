  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("ComissionMemberAssignment") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            <CCol lg="1" md="5" sm="1" class="text-left mt-2 pl-0">
              <CButton
                @click="Refresh"
                size="sm"
                color="primary"
            ...
            <CCol lg="2" md="1" sm="12" class="text-lg-right mt-2">
              <CButton
                @click="Create"
                color="primary"
                variant="outline"
...
export default {
  ...
  methods: {
    ...
    // },
    Delete(item) {
      ComissionMemberAssignmentService.Delete(item.id)
        .then((res) => {
          this.makeToast(
    ...
    Approve(item) {
      var self = this;
      ComissionMemberAssignmentService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      ComissionMemberAssignmentService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
    ...
    Refresh() {
      this.isBusy = true;
      ComissionMemberAssignmentService.GetList(
