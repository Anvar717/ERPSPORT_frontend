  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("HRTimeSheet") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            >
              <CButton
                v-if="$can('HRTimeSheetEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    <b-dropdown-item
                      v-if="$can('HRTimeSheetApprove', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HRTimeSheetCancelApproval', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HRTimeSheetDelete', 'permissions')"
                    ...
                    <!-- <b-dropdown-item
                      ...
                      v-if="$can('HRTimeSheetReject','permissions')"
                    >
