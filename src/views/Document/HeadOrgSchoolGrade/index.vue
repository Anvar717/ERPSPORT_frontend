  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("HeadOrgSchoolGrade") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            <CCol lg="3" md="3" sm="12" class="text-right mt-2">
              <div>
            ...
            <CCol lg="4" md="4" sm="12" class="text-lg-right mt-2">
              <CButton
                v-if="$can('HeadOrgSchoolGradeEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    <b-dropdown-item
                      v-if="$can('HeadOrgSchoolGradeAccept', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HeadOrgSchoolGradeCancel', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HeadOrgSchoolGradeDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      HeadOrgSchoolGradeService.Delete(item.id)
        .then((res) => {
          this.makeToast(
    ...
    Approve(item) {
      var self = this;
      HeadOrgSchoolGradeService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    Cancel(item) {
      var self = this;
      HeadOrgSchoolGradeService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
    ...
    Refresh() {
      this.isBusy = true;
      HeadOrgSchoolGradeService.GetList(
