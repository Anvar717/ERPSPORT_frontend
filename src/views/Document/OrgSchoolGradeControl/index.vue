  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("OrgSchoolGradeControl") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            <CCol lg="4" md="4" sm="12" class="text-lg-right mt-2">
              <CButton
                v-if="$can('OrgSchoolGradeControlEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    ...
                    <b-dropdown-item
                      v-if="
                        $can(
                          'OrgSchoolGradeControlCancelApproval',
                          'permissions'
                        )
                      "
                    ...
                    <b-dropdown-item
                      v-if="$can('OrgSchoolGradeControlDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Approve(item) {
      var self = this;
      OrgSchoolGradeControlService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    Cancel(item) {
      var self = this;
      OrgSchoolGradeControlService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
    ...
    Refresh() {
      this.isBusy = true;
      OrgSchoolGradeControlService.GetList(
        this.filter.Search,
