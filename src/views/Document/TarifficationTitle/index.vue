  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("TarifficationTitle") }}</h3>
        <CCardHeader>
            ...
            <template v-slot:cell(actions)="row">
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    <b-dropdown-item
                      v-if="$can('TarifficationTitleAccept', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('TarifficationTitleCancel', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('TarifficationTitleDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    CancelApproval(item) {
      var self = this;
      TarifficationTitleService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
    ...
    Refresh() {
      this.isBusy = true;
      TarifficationTitleService.GetList(
