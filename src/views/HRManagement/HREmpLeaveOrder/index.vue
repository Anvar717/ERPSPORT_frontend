  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("HREmpLeaveOrder") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            >
              <CButton
                v-if="$can('HREmpLeaveOrderEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    <b-dropdown-item
                      v-if="$can('HREmpLeaveOrderAccept', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HREmpLeaveOrderCancel', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HREmpLeaveOrderDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Approve(item) {
      var self = this;
      HREmpLeaveOrderService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      HREmpLeaveOrderService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
