  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("HREmpSickLeave") }}</h3>
        <CCardHeader>
          <b-row class="d-flex justify-content-between">
            ...
            <b-col class="mt-3 text-lg-right float-lg-right" lg="5" md="5" sm="12">
              <div class="d-flex float-lg-right mt-2">
                <CButton
                  v-if="$can('HREmpSickLeaveEdit', 'permissions')"
                  @click="Create"
                  color="primary"
                  variant="outline"
                  class="mr-2"
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    <b-dropdown-item
                      v-if="$can('HREmpSickLeaveAccept', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HREmpSickLeaveCancel', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HREmpSickLeaveDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Approve(item) {
      var self = this;
      HREmpSickLeaveService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      HREmpSickLeaveService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
