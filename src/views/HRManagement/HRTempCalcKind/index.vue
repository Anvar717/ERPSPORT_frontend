  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("HRTempCalcKind") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            >
              <CButton
                v-if="$can('HRTempCalcKindEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    <b-dropdown-item
                      v-if="$can('HRTempCalcKindAccept', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HRTempCalcKindCancel', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HRTempCalcKindDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      HRTempCalcKindService.Delete(item.id)
        .then((res) => {
          this.makeToast(
    ...
    Approve(item) {
      var self = this;
      HRTempCalcKindService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      HRTempCalcKindService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
