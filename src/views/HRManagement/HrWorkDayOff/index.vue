  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("HrWorkDayOff") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            >
              <CButton
                v-if="$can('HrWorkDayOffEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    <b-dropdown-item
                      v-if="$can('HrWorkDayOffAccept', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HrWorkDayOffCancel', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('HrWorkDayOffDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Approve(item) {
      var self = this;
      HrWorkDayOffService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      HrWorkDayOffService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
