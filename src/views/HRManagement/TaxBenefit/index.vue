  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("TaxBenefit") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            >
              <CButton
                v-if="$can('TaxBenefitEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    <b-dropdown-item
                      v-if="$can('TaxBenefitAccept', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('TaxBenefitCancel', 'permissions')"
                    ...
                    <b-dropdown-item
                      v-if="$can('TaxBenefitDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Approve(item) {
      var self = this;
      TaxBenefitService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      TaxBenefitService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
