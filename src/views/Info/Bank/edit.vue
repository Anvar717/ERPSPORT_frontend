    ...
    <CCol>
      <CCard accent-color="primary" class="pb-4">
        <CCardHeader>
          <CRow>
            <CCol>
              <h4 class="text-center">{{$t('Bank')}}</h4>
            </CCol>
          </CRow>
        </CCardHeader>
        <CCardBody>
...
export default {
  ...
  methods: {
    ...
    check() {
      ...
      if (
        self.Bank.Bankname === 0 ||
        self.Bank.Bankname === null ||
        self.Bank.Bankname === undefined ||
        self.Bank.Bankname === ""
      ) {
        this.makeToast(
          this.$t("BanknameNotCorrect"),
          this.$t("Error"),
          "danger"
        );
        return false;
      ...
      if (
        self.Bank.Stateid === 0 ||
        self.Bank.Stateid === null ||
        self.Bank.Stateid === undefined ||
        self.Bank.Stateid === ""
      ) {
