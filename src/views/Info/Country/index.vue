  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("Country") }}</h3>
        <CCardHeader>
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(numbercode)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('numbercode')"
              >
                {{ $t("numbercode") }}
                <b-icon v-if="filter.SortColumn === 'numbercode'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
