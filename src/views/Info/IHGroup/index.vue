  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("IHGroup") }}</h3>
        <CCardHeader>
          <CRow class="form-group justify-content-between">
            ...
            <CCol lg="7" md="6" sm="12" class="text-lg-right mt-2" style="margin-right: -7px;">
              <CButton
                v-if="$can('IHGroupEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(parentname)>
              ...
              >
                {{ $t("parentname") }}
                <b-icon v-if="filter.SortColumn === 'parentname'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            <template v-slot:head(isgroup)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('isgroup')"
              >
                {{ $t("isgroup") }}
                <b-icon v-if="filter.SortColumn === 'isgroup'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-link
                  v-if="$can('IHGroupDelete', 'permissions')"
