    ...
    <CCol>
      <CCard accent-color="primary" class="pb-4">
        <CCardHeader>
          <CRow>
            <CCol>
              <h4 class="text-center">{{$t('KinshipDegree')}}</h4>
            </CCol>
          </CRow>
        </CCardHeader>
        <CCardBody>
            ...
            <CCol>
              <div class="text-left">
                <CButton
                  ...
                  size="sm"
                  color="danger"
                  @click="$router.push({name : 'KinshipDegree'})"
                >
...
export default {
  ...
  created() {
    ...
    KinshipDegreeService.Get(this.$route.params.id).then(res => {
  ...
  methods: {
    check() {
      ...
      if (
        self.KinshipDegree.code === 0 ||
        self.KinshipDegree.code === null ||
        self.KinshipDegree.code === undefined ||
        self.KinshipDegree.code === ""
      ) {
        this.makeToast(this.$t("codeNotCorrect"), this.$t("Error"), "danger");
        return false;
      }
      if (
        self.KinshipDegree.shortname === 0 ||
        self.KinshipDegree.shortname === null ||
        self.KinshipDegree.shortname === undefined ||
        self.KinshipDegree.shortname === ""
      ) {
        this.makeToast(
      ...
      if (
        self.KinshipDegree.fullname === 0 ||
        self.KinshipDegree.fullname === null ||
        self.KinshipDegree.fullname === undefined ||
        self.KinshipDegree.fullname === ""
      ) {
        this.makeToast(
      ...
      if (
        self.KinshipDegree.stateid === 0 ||
        self.KinshipDegree.stateid === null ||
        self.KinshipDegree.stateid === undefined ||
        self.KinshipDegree.stateid === ""
      ) {
    ...
    AddItem() {
      if (this.TranslatebyName == "shortname") {
        this.ItemsPush();
        this.KinshipDegreeTranslatePush();
    ...
    KinshipDegreeTranslatePush() {
      this.KinshipDegree.Translates.push({
        languageid: this.Translate.languageid,
        languagename: this.LanguageList.filter(
          item => item.id == this.Translate.languageid
        )[0].name,
