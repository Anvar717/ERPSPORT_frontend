  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("Position") }}</h3>
        <CCardHeader>
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(positionclassificationname)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('positionclassificationname')"
              >
                {{ $t("positionclassificationname") }}
                <b-icon
                  v-if="filter.SortColumn === 'positionclassificationname'"
                  :icon="filter.SortIcon"
                ></b-icon>
              </div>
            </template>
            <template v-slot:head(tariffscaletypename)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('tariffscaletypename')"
              >
                {{ $t("tariffscaletypename") }}
                <b-icon
                  v-if="filter.SortColumn === 'tariffscaletypename'"
                  :icon="filter.SortIcon"
                ></b-icon>
              </div>
            </template>
    ...
    return {
      fields: [
        ...
        },
        {
          ...
          label: this.$t("positionclassificationname"),
          sortable: false,
          class: "text-left",
        },
        {
        ...
        {
          key: "tariffscaletypename",
          label: this.$t("tariffscaletypename"),
          sortable: false,
          class: "text-left",
        },
        {
