  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("PositionClassification") }}</h3>
        <CCardHeader>
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(nscocode)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('nscocode')"
              >
                {{ $t("nscocode") }}
                <b-icon v-if="filter.SortColumn === 'nscocode'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            ...
            <template v-slot:head(categoryname)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('categoryname')"
              >
                {{ $t("categoryname") }}
                <b-icon v-if="filter.SortColumn === 'categoryname'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
...
<script>
import PositionClassificationService from "@/services/PositionClassification.service";
export default {
  data() {
    return {
      fields: [
