  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("Region") }}</h3>
        <CCardHeader>
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(oblast)>
              ...
              >
                {{ $t("oblast") }}
                <b-icon v-if="filter.SortColumn === 'oblast'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            <template v-slot:head(soatocode)>
              ...
              >
                {{ $t("soatocode") }}
                <b-icon v-if="filter.SortColumn === 'soatocode'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
