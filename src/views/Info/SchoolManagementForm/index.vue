  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("SchoolManagementForm") }}</h3>
        <CCardHeader>
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                >
                 ...
                 <!-- v-if="$can('SchoolManagementFormEdit', 'permissions')" -->
                  <!-- v-if="$can('SchoolManagementFormDelete', 'permissions')" -->
              </div>
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      SchoolManagementFormService.Delete(item.id)
        .then((res) => {
          this.makeToast(
    ...
    Refresh() {
      this.isBusy = true;
      SchoolManagementFormService.GetList(
        this.filter.Search,
