  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("SchoolYear") }}</h3>
        <CCardHeader>
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:cell(isactive)="{ item }">
              <CBadge
                ><p>{{ item.isactive ? $t("yes") : $t("no") }}</p></CBadge
              >
            </template>
            <template v-slot:cell(isadmissionyear)="{ item }">
              <CBadge
                ><p>{{ item.isadmissionyear ? $t("yes") : $t("no") }}</p></CBadge
              >
            </template>
