    ...
    <CCol>
      <CCard accent-color="primary" class="pb-4">
        <CCardHeader>
          <CRow>
            <CCol>
              <h4 class="text-center">{{$t('StaffTypeBasicTariff')}}</h4>
            </CCol>
          </CRow>
        </CCardHeader>
        <CCardBody>
              ...
              <CCol sm="6">
                <ValidationProvider v-slot="v" name="code" rules="required">
                  ...
                  >
                    <template #append>
                      <CButton
                        v-if="StaffTypeBasicTariff.TranslatableColumns.includes('shortname')"
              ...
              <CCol sm="6">
                <ValidationProvider v-slot="v" name="code" rules="required">
                  ...
                  >
                    <template #append>
                      <CButton
                        v-if="StaffTypeBasicTariff.TranslatableColumns.includes('fullname')"
          ...
          <CCol>
            <div class="text-left">
              <CButton
                ...
                size="sm"
                color="danger"
                @click="$router.push({name : 'StaffTypeBasicTariff'})"
              >
...
export default {
  data() {
    return {
      ...
      StaffTypeBasicTariff: { TranslatableColumns: [] },
      selectedrowid: 0,
      translitefields: [
  ...
  created() {
    ...
    StaffTypeBasicTariffService.Get(self.selectedrowid).then(res => {
      self.StaffTypeBasicTariff = res.data;
    });
  },
  methods: {
    check() {
      ...
      if (
        self.StaffTypeBasicTariff.code === 0 ||
        self.StaffTypeBasicTariff.code === null ||
        self.StaffTypeBasicTariff.code === undefined ||
        self.StaffTypeBasicTariff.code === ""
      ) {
        this.makeToast(this.$t("codeNotCorrect"), this.$t("Error"), "danger");
        return false;
      }
      if (
        self.StaffTypeBasicTariff.shortname === 0 ||
        self.StaffTypeBasicTariff.shortname === null ||
        self.StaffTypeBasicTariff.shortname === undefined ||
        self.StaffTypeBasicTariff.shortname === ""
      ) {
        this.makeToast(
      ...
      if (
        self.StaffTypeBasicTariff.fullname === 0 ||
        self.StaffTypeBasicTariff.fullname === null ||
        self.StaffTypeBasicTariff.fullname === undefined ||
        self.StaffTypeBasicTariff.fullname === ""
      ) {
        this.makeToast(
      ...
      if (
        self.StaffTypeBasicTariff.normativedoc === 0 ||
        self.StaffTypeBasicTariff.normativedoc === null ||
        self.StaffTypeBasicTariff.normativedoc === undefined ||
        self.StaffTypeBasicTariff.normativedoc === ""
      ) {
        this.makeToast(
      ...
      if (
        self.StaffTypeBasicTariff.stateid === 0 ||
        self.StaffTypeBasicTariff.stateid === null ||
        self.StaffTypeBasicTariff.stateid === undefined ||
        self.StaffTypeBasicTariff.stateid === ""
      ) {
    ...
    SaveData() {
      ...
      var self = this;
      StaffTypeBasicTariffService.Update(self.StaffTypeBasicTariff)
        .then(res => {
          self.makeToast(
          ...
          self.$router.push({ name: "StaffTypeBasicTariff" });
        })
        .catch(error => {
          self.makeToast(
    ...
    translate(selectcolumnname) {
      ...
      self.translatelist = self.StaffTypeBasicTariff.Translates.filter(
    ...
    SaveTranslate() {
      var self = this;
      self.StaffTypeBasicTariff.Translates = self.StaffTypeBasicTariff.Translates.filter(
        x => x.columnname !== self.translatebyname
      );
      self.translatelist.forEach(item => {
        self.StaffTypeBasicTariff.Translates.push(item);
      });
