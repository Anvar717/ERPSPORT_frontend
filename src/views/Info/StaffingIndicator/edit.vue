    ...
    <CCol>
      <CCard accent-color="primary" class="pb-4">
        <CCardHeader>
          <CRow>
            <CCol>
              <h4 class="text-center">{{$t('StaffingIndicator')}}</h4>
            </CCol>
          </CRow>
        </CCardHeader>
        <CCardBody>
              ...
              <CCol sm="6">
                <ValidationProvider v-slot="v" name="code" rules="required|max:9">
                  <CInput
                    ...
                    horizontal
                    :label="$t('code')"
                    v-model="StaffingIndicator.code"
              ...
              <CCol sm="6">
                <ValidationProvider v-slot="v" name="code" rules="required">
                  <CInput
                    ...
                    horizontal
                    :label="$t('shortname')"
                    v-model="StaffingIndicator.shortname"
                    :addInputClasses="{'is-invalid': v.classes.invalid,'is-valid':  v.classes.valid }"
                  >
                    <template #append>
                      <CButton
                        v-if="StaffingIndicator.TranslatableColumns.includes('shortname')"
              ...
              <CCol sm="6">
                <ValidationProvider v-slot="v" name="code" rules="required">
                  <CInput
                    ...
                    horizontal
                    :label="$t('fullname')"
                    v-model="StaffingIndicator.fullname"
                    :addInputClasses="{'is-invalid': v.classes.invalid,'is-valid':  v.classes.valid }"
                  >
                    <template #append>
                      <CButton
                        v-if="StaffingIndicator.TranslatableColumns.includes('fullname')"
                ...
                <ValidationProvider v-slot="v" name="startdate" rules="required">
                  <div class="form-group form-row">
                    ...
                    <div class="col-sm-9">
                      <!-- <custom-date-input />  -->
                      <date-picker
                        v-model="StaffingIndicator.startdate"
                        style="width:100%"
                        size="sm"
                        lang="ru"
                ...
                <ValidationProvider v-slot="v" name="enddate" rules="required">
                  <div class="form-group form-row">
                    ...
                    <div class="col-sm-9">
                      <!-- <custom-date-input />  -->
                      <date-picker
                        v-model="StaffingIndicator.enddate"
                        style="width:100%"
                        size="sm"
                        lang="ru"
              ...
              <CCol sm="6">
                <div class="form-group form-row">
                  ...
                  <v-select
                    class="col-sm-9"
                    :options="statelist"
                    v-model="StaffingIndicator.stateid"
                    :reduce="item => item.id"
          ...
          <CCol>
            <div class="text-left">
              <CButton
                ...
                size="sm"
                color="danger"
                @click="$router.push({name : 'StaffingIndicator'})"
              >
...
import StaffingIndicatorService from "@/services/StaffingIndicator.service";
export default {
  data() {
    return {
      SaveLoading: false,
      translatemodal: false,
      StaffingIndicator: { TranslatableColumns: [] },
      selectedrowid: 0,
      translitefields: [
  ...
  created() {
    ...
    StaffingIndicatorService.Get(self.selectedrowid).then(res => {
      self.StaffingIndicator = res.data;
    });
  },
  methods: {
    check() {
      ...
      if (
        self.StaffingIndicator.code === 0 ||
        self.StaffingIndicator.code === null ||
        self.StaffingIndicator.code === undefined ||
        self.StaffingIndicator.code === ""
      ) {
        this.makeToast(this.$t("codeNotCorrect"), this.$t("Error"), "danger");
        return false;
      }
      if (
        self.StaffingIndicator.shortname === 0 ||
        self.StaffingIndicator.shortname === null ||
        self.StaffingIndicator.shortname === undefined ||
        self.StaffingIndicator.shortname === ""
      ) {
        this.makeToast(
      ...
      if (
        self.StaffingIndicator.fullname === 0 ||
        self.StaffingIndicator.fullname === null ||
        self.StaffingIndicator.fullname === undefined ||
        self.StaffingIndicator.fullname === ""
      ) {
        this.makeToast(
      ...
      if (
        self.StaffingIndicator.startdate === 0 ||
        self.StaffingIndicator.startdate === null ||
        self.StaffingIndicator.startdate === undefined ||
        self.StaffingIndicator.startdate === ""
      ) {
        this.makeToast(
      ...
      /* if (
        self.StaffingIndicator.enddate === 0 ||
        self.StaffingIndicator.enddate === null ||
        self.StaffingIndicator.enddate === undefined ||
        self.StaffingIndicator.enddate === ""
      ) {
        this.makeToast(
      ...
      if (
        self.StaffingIndicator.stateid === 0 ||
        self.StaffingIndicator.stateid === null ||
        self.StaffingIndicator.stateid === undefined ||
        self.StaffingIndicator.stateid === ""
      ) {
    ...
    SaveData() {
      ...
      var self = this;
      StaffingIndicatorService.Update(self.StaffingIndicator)
        .then(res => {
          self.makeToast(
          ...
          self.$router.push({ name: "StaffingIndicator" });
        })
        .catch(error => {
          self.makeToast(
    ...
    translate(selectcolumnname) {
      ...
      self.translatelist = self.StaffingIndicator.Translates.filter(
    ...
    SaveTranslate() {
      var self = this;
      self.StaffingIndicator.Translates = self.StaffingIndicator.Translates.filter(
        x => x.columnname !== self.translatebyname
      );
      self.translatelist.forEach(item => {
        self.StaffingIndicator.Translates.push(item);
      });
