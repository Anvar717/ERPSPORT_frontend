  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("Street") }}</h3>
        <CCardHeader>
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(code)>
             ...
             <template v-slot:head(streettype)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('streettype')"
              >
                {{ $t("streettype") }}
                <b-icon v-if="filter.SortColumn === 'streettype'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
