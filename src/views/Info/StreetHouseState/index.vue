  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("StreetHouseState") }}</h3>
        <CCardHeader>
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(street)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('street')"
              >
                {{ $t("street") }}
                <b-icon
                  v-if="filter.SortColumn === 'street'"
                  :icon="filter.SortIcon"
                ></b-icon>
              </div>
            </template>
            <template v-slot:head(streethouse)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('streethouse')"
              >
                {{ $t("streethouse") }}
                <b-icon
                  v-if="filter.SortColumn === 'streethouse'"
                  :icon="filter.SortIcon"
                ></b-icon>
              </div>
            </template>
