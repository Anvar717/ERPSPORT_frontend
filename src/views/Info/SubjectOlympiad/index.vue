  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("SubjectOlympiad") }}</h3>
        <CCardHeader>
          <CRow class="form-group justify-content-between">
            ...
            <CCol lg="7" md="6" sm="12" class="text-lg-right mt-2" style="margin-right: -7px;">
              <CButton
                v-if="$can('SubjectOlympiadEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(islocalolympiad)>
              <div
                class="text-center"
                style="cursor: pointer"
                @click="ChangeSort('islocalolympiad')"
              >
                {{ $t("islocalolympiad") }}
                <b-icon v-if="filter.SortColumn === 'islocalolympiad'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            ...
            <template v-slot:cell(islocalolympiad)="{ item }">
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-link
                  v-if="$can('SubjectOlympiadDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    Delete(item) {
      SubjectOlympiadService.Delete(item.id)
        .then((res) => {
          this.makeToast(
