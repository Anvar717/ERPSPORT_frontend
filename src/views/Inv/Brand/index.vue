  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("Brand") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            <CCol lg="7" md="6" sm="12" class="text-lg-right mt-2">
              <CButton
                ...
                size="sm"
              >
                <!-- v-if="$can('BrandEdit', 'permissions')" -->
  ...
  data() {
    return {
      fields: [
        ...
        {
          key: "productclassificationname",
          label: this.$t("ProductClassification"),
          sortable: false,
          thClass: "text-center",
          tdClass: "text-center",
        },
