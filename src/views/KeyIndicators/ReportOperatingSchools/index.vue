    ...
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <b-row class="mt-3 mx-1">
          <b-col>
            <h4 class="text-left">{{$t('Халқ таълим тизимида фаолият кўрсатаётган умумий ўрта таълим мактаблари ҳақида маълумот')}}</h4>
          </b-col>
            ...
            <thead>
              <tr>
                ...
                <th style="text-align: center">
                  {{ $t("decommissionedschools") }}
                </th>
                <th style="text-align: center;vertical-align: middle">
                  {{ $t("schoolstransferred") }}
                </th>
                <th style="text-align: center">{{ $t("newlyschools") }}</th>
                <th style="text-align: center">{{ $t("endtotalcases") }}</th>
              </tr>
            </thead>
