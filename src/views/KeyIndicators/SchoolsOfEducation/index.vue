    ...
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <b-row class="mt-3 mx-1">
          <b-col>
            <h4 class="text-left">{{ $t("SchoolsOfEducation") }}</h4>
          </b-col>
...
export default {
  ...
  methods: {
    ...
    Print() {
      ReportLearningProcessService.PrintOrgSchoolGradeCountByLanguage(
        ...
        .then((response) => {
          ...
          fileLink.setAttribute("download", "SchoolsOfEducation.xlsx");
