<template>
    <CRow>
      <CCol sm="12" md="12">
        <CCard accent-color="primary">
          <h3 class="text-center mt-3">{{ $t("OrgTourniquetDevice") }}</h3>
          <CCardHeader>
            <CRow class="form-group">
              <CCol lg="6" md="5" sm="11" class="text-left mt-2">
                <div class="d-flex">
                  <CInput
              ...
              <CCol lg="6" md="6" sm="12" class="text-lg-right mt-2">
                <CButton
                  @click="Create"
                  color="primary"
                  variant="outline"
            ...
            >
              ...
              <template v-slot:cell(actions)="{ item }">
                <div class="text-center">
                  <b-link
                    @click="Edit(item)"
                    v-if="$can('OrgTourniquetDeviceEdit','permissions')"
                    class="mr-2"
                  ...
                  <b-link
                    ...
                    class="mr-2"
                    v-if="$can('OrgTourniquetDeviceDelete','permissions')"
  ...
  export default {
    data() {
      return {
        fields: [
          ...
          {
            key: "orgtourniquetusername",
            label: this.$t("orgtourniquetuser"),
            sortable: false,
            thClass: "text-center",
            tdClass: "text-left"
          },
          {
            key: "address",
            label: this.$t("OrganizationBuildingInfo"),
            sortable: false,
            thClass: "text-center",
            tdClass: "text-left"
          },
    ...
    methods: {
      ...
      rowclicked() {},
      Create() {
        this.$router.push("/Management/OrgTourniquetDevice/edit/id=0");
      },
      Edit(item) {
        this.$router.push(`/Management/OrgTourniquetDevice/edit/id=${item.id}`);
      },
      Delete(item) {
        OrgTourniquetDeviceService.Delete(item.id)
          .then((res) => {
            this.makeToast(
      ...
      Refresh() {
        this.isBusy = true;
        OrgTourniquetDeviceService.GetList(
          this.filter.Search,
