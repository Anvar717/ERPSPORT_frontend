  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("Roles") }}</h3>
        <CCardHeader>
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(isdefault)>
              <div style="cursor : pointer" @click="ChangeSort('isdefault')">
                {{ $t("isdefault") }}
                <b-icon v-if="filter.SortColumn === 'isdefault'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
  ...
  data() {
    return {
      fields: [
        ...
        { key: "shortname", label: this.$t("shortname"), sortable: false },
        { key: "isdefault", label: this.$t("isdefault"), sortable: false },
      ],
      items: [],
      totalRows: "",
      isBusy: true,
