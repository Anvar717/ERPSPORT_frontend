  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("Table") }}</h3>
        <CCardHeader>
              ...
              <div class="text-center">
                ...
                <!-- <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                    ...
                    <div>
                      ...
                      <b-dropdown-item
                        v-if="$can('OrgStateInfoDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    //   Approve(item) {
    //     var self = this;
    //     OrgStateInfoService.Approve(item.id)
    //       .then((res) => {
    //         self.makeToast(
    ...
    //   CancelApproval(item) {
    //     var self = this;
    //     OrgStateInfoService.CancelApproval(item.id)
    //       .then((res) => {
    //         self.makeToast(
