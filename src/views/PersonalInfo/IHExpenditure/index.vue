  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("IHExpenditure") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            <CCol lg="7" md="6" sm="12" class="text-lg-right mt-2">
              <CButton
                v-if="$can('IHExpenditureEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
              ...
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    ...
                    <b-dropdown-item
                      v-if="$can('IHExpenditureDelete', 'permissions')"
...
export default {
  data() {
    return {
      fields: [
        ...
        {
          key: "ihexpenditurenumber",
          label: this.$t("ihexpenditurenumber"),
          sortable: false,
        },
        {
          key: "ihexpendituredate",
          label: this.$t("ihexpendituredate"),
          sortable: false,
        },
        /*         {
          key: "startdate",
        ...
        {
          key: "ihexpendituresum",
          label: this.$t("ihexpendituresum"),
          sortable: false,
        },
        {
          key: "status",
  ...
  methods: {
    ...
    Delete(item) {
      IHExpenditureService.Delete(item.id)
        .then((res) => {
          this.makeToast(
    ...
    Approve(item) {
      var self = this;
      IHExpenditureService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      IHExpenditureService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
