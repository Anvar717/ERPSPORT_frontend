  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("IHMenu") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            <CCol lg="7" md="6" sm="12" class="text-lg-right mt-2">
              <CButton
                v-if="$can('IHMenuEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
              ...
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    ...
                    <b-dropdown-item
                      v-if="$can('IHMenuDelete', 'permissions')"
...
export default {
  ...
  methods: {
    ...
    CancelApproval(item) {
      var self = this;
      IHMenuService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
