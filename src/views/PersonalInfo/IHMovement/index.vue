  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("IHMovement") }}</h3>
        <CCardHeader>
          <CRow class="form-group">
            ...
            <CCol lg="7" md="6" sm="12" class="text-lg-right mt-2">
              <CButton
                v-if="$can('IHMovementEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(ihmovementnumber)>
              <div
                style="cursor : pointer"
                @click="ChangeSort('ihmovementnumber')"
              >
                {{ $t("ihmovementnumber") }}
                <b-icon v-if="filter.SortColumn === 'ihmovementnumber'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            <template v-slot:head(ihmovementdate)>
              <div
                style="cursor : pointer"
                @click="ChangeSort('ihmovementdate')"
              >
                {{ $t("ihmovementdate") }}
                <b-icon v-if="filter.SortColumn === 'ihmovementdate'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            <template v-slot:head(ihmovementsum)>
              <div
                style="cursor : pointer"
                @click="ChangeSort('ihmovementsum')"
              >
                {{ $t("ihmovementsum") }}
                <b-icon v-if="filter.SortColumn === 'ihmovementsum'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            ...
            <template v-slot:head(fromdepartmentname)>
              <div
                style="cursor : pointer"
                @click="ChangeSort('fromdepartmentname')"
              >
                {{ $t("fromdepartmentname") }}
                <b-icon v-if="filter.SortColumn === 'fromdepartmentname'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            <template v-slot:head(fromresponsiblepersonname)>
              <div
                style="cursor : pointer"
                @click="ChangeSort('fromresponsiblepersonname')"
              >
                {{ $t("fromresponsiblepersonname") }}
                <b-icon v-if="filter.SortColumn === 'fromresponsiblepersonname'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            <template v-slot:head(todepartmentname)>
              <div
                style="cursor : pointer"
                @click="ChangeSort('todepartmentname')"
              >
                {{ $t("todepartmentname") }}
                <b-icon v-if="filter.SortColumn === 'todepartmentname'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            <template v-slot:head(toresponsiblepersonname)>
              <div
                style="cursor : pointer"
                @click="ChangeSort('toresponsiblepersonname')"
              >
                {{ $t("toresponsiblepersonname") }}
                <b-icon v-if="filter.SortColumn === 'toresponsiblepersonname'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
              ...
              <div class="text-center">
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    ...
                    <b-dropdown-item
                      v-if="$can('IHMovementDelete', 'permissions')"
...
export default {
  data() {
    return {
      fields: [
        ...
        {
          key: "ihmovementnumber",
          label: this.$t("ihmovementnumber"),
          sortable: false,
        },
        {
          key: "ihmovementdate",
          label: this.$t("ihmovementdate"),
          sortable: false,
        },
        {
          key: "ihmovementsum",
          label: this.$t("ihmovementsum"),
          sortable: false,
        },
        {
          key: "detailinfo",
        ...
        {
          key: "fromresponsiblepersonname",
          label: this.$t("fromresponsiblepersonname"),
          sortable: false,
        },
        {
          key: "todepartmentname",
          label: this.$t("todepartmentname"),
          sortable: false,
        },
        {
          key: "toresponsiblepersonname",
          label: this.$t("toresponsiblepersonname"),
          sortable: false,
        },
        {
          key: "status",
  ...
  methods: {
    ...
    Delete(item) {
      IHMovementService.Delete(item.id)
        .then((res) => {
          this.makeToast(
    ...
    Approve(item) {
      var self = this;
      IHMovementService.Approve(item.id)
        .then((res) => {
          self.makeToast(
    ...
    CancelApproval(item) {
      var self = this;
      IHMovementService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
