      ...
      <CCard accent-color="primary">
        ...
        <CCardHeader>
          <CRow class="form-group">
            ...
            <CCol lg="4" md="6" sm="12" class="text-lg-right mt-2">
              <CButton
                v-if="$can('OrgSchoolGradeEdit', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(schoolgrade)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('schoolgrade')"
              >
                {{ $t("schoolgrade") }}
                <b-icon
                  v-if="filter.SortColumn === 'schoolgrade'"
                  :icon="filter.SortIcon"
                ></b-icon>
              </div>
            </template>
            <template v-slot:head(schoolgradeletter)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('schoolgradeletter')"
              >
                {{ $t("schoolgradeletter") }}
                <b-icon
                  v-if="filter.SortColumn === 'schoolgradeletter'"
                  :icon="filter.SortIcon"
                ></b-icon>
              </div>
            </template>
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-link
                  v-if="$can('OrgSchoolGradeDelete', 'permissions')"
...
export default {
  ...
  created() {
    this.filter.schoolgradeid = this.$route.query.schoolgradeid || 0;
  ...
  methods: {
    ...
    Edit(item) {
      this.$router.push({
        ...
        query: {
          schoolgradeid: this.filter.schoolgradeid,
        },
      });
    },
    Delete(item) {
      OrgSchoolGradeService.Delete(item.id)
        .then((res) => {
          this.makeToast(
