  ...
  <CRow>
    <CCol class="p-0">
      <CCard accent-color="primary" class="pb-4">
        <CCardHeader v-if="showBackButton">
          <b-row>
            <b-col
              sm="12"
              md="6"
            ...
            >
              <h4 v-if="persontypeid == 1">{{ $t("Student") }}</h4>
              <h4 v-if="persontypeid == 2">{{ $t("Employee") }}</h4>
            </b-col>
            <b-col sm="12" md="6" class="text-right">
              <b-button-group size="sm" v-if="$route.params.id != 0">
                <b-button
                  ...
                  >{{
                    persontypeid == 1 ? $t("gotoStudent") : $t("gotoEmployee")
                  }}
        ...
        <CCardBody class="p-2">
          <CCard v-if="isView()">
            <CCardBody>
              <b-row>
                ...
                <b-col sm="2" lg="2" class="text-left">
              ...
              <b-row sm="12" md="12">
                          ...
                          <div class="col-sm-9">
                            <date-picker
                              ...
                              :disabled="
                                ...
                                filter.identitydocumentid != 6
                              "
                              v-if="filter.identitydocumentid != 6"
                              style="width: 100%"
                              size="sm"
                              lang="ru"
                              :placeholder="$t('dateofbirth')"
                ...
                <b-col sm="12" md="6">
                  <b-row>
                    ...
                    <b-col sm="12" md="12" v-if="person.birthcountryid == 211">
                      <ValidationProvider
                        v-slot="v"
                        name="birthregion"
                        rules="required"
                    ...
                    >
                      <b-row>
                        ...
                        <b-col sm="12" md="8">
                          <div
                            class="d-flex my-1"
                            v-for="(item, index) in person.AttachedFiles"
                            :key="index"
                          ...
                          >
                            <b-button-group size="sm">
                              <b-button
                                ...
                                ><b-icon
                                  v-if="
                                    DownloadLoading != item.attachmentfileid
                                  "
                                  icon="download"
                                ></b-icon>
                                <b-spinner
                              ...
                              <b-button
                                ...
                                >
                                  <b-spinner
                                    small
                                    v-if="
                                      DeleteLoading == item.attachmentfileid
                                    "
                                  ></b-spinner> </b-icon
                              ></b-button>
                            </b-button-group>
                ...
                <CCol>
                  <div class="float-right">
                    ...
                    <CButton
                      ...
                      class="mb-n3"
                      v-if="tabIndex == 2 && person.CanSave"
                      color="primary"
                    >
                      <b-icon icon="plus"> </b-icon>
                      {{ $t("Add") }}
                  ...
                  <b-tabs pills v-model="tabIndex">
                            ...
                            <template v-slot:cell(actions)="{ item }">
                              <div class="text-center">
                                ...
                                <b-link
                                  class="mr-2"
                                  v-c-tooltip="{ content: $t('Delete') }"
                                  @click="DeleteItemRelativeTables(item)"
                                >
                                  <b-icon icon="trash"></b-icon>
                                </b-link>
                              </div>
                      ...
                      <CRow class="mt-4">
                        <c-col>
                          <b-table
                            ...
                            :items="person.PersonExperienceTables"
                            class="bg-color-table text-center"
                            style="vertical-align: middle"
                            bordered
                            responsive="md"
                    ...
                    >
                      <CRow class="mt-4">
                        <c-col>
                          <b-table
                            :fields="fieldsPersonDiploms"
                            :items="person.PersonDiploms"
                            class="bg-color-table text-center"
                            style="vertical-align: middle"
                            bordered
                            responsive="md"
          ...
          <b-modal id="AddModal" size="xl" modal-class="custom-size-modal">
            ...
            <b-row>
              ...
              <b-col sm="12" md="1" class="text-left mt-2">
                <label>{{ $t("documentseries") }}</label>
                <v-select
                  v-if="filteridentitydocserieslist.length > 0"
                  :options="filteridentitydocserieslist"
              ...
              <b-col
              v-if="
                  relative.identitydocumentid == 3 ||
                  relative.identitydocumentid == 4
                "
                sm="12"
                md="3"
                class="mt-2"
              ...
              v-if="
                ...
                "
              sm="12" md="2" class=" d-flex align-items-center">
                <label > </label>                
                <b-input-group>
                  <b-button                   
                  variant="primary" @click="SearchByPinflRelative">
            ...
            <b-row class="mt-2">
              ...
              <b-col sm="12" md="2" class="mt-2 mt-md-0">
            ...
            <CRow class="divider my-4" v-if="!relativetabrow.hasdied">
              <CCol>
            ...
            <CRow v-if="!relativetabrow.hasdied">
              <CCol sm="12" md="3">
              ...
              <CCol
                ...
                md="3"
                class="mt-2 mt-md-0"
                v-if="relativetabrow.countryid == 211"
              >
            ...
            <!-- </CRow>
            <CRow class="mt-3" v-if="!relativetabrow.hasdied"> -->
              <CCol sm="12" md="3" v-if="relativetabrow.countryid == 211">
                <label>{{ $t("mfy") }}</label>
                <v-select
            ...
            <CRow class="mt-3">
              ...
              <CCol sm="12" md="4" class="mt-2 mt-md-0">
                <label>{{ $t("documentseries") }}</label>
                <v-select
            ...
            <template v-slot:modal-footer>
              <div class="text-center mx-auto">
                ...
                <CButton size="sm" color="primary" @click="AddItemRelative">
                  <b-icon icon="check2"></b-icon>
                  {{ $t("Save") }}
                </CButton>
              </div>
      ...
      >
            ...
            <b-row>
              ...
              <b-col sm="12">
                ...
                <label
                  for=""
                  v-if="
                    CheckDoc.identitydocumentid == 3 ||
                    CheckDoc.identitydocumentid == 4
                  "
                >
                  {{ $t("pinfl") }}
                </label>
                ...
                <b-input-group class="d-flex w-100">
                  ...
                  <b-input-group-append>
                    <b-button
                      variant="primary"
                      :disabled="
                        (!CheckDoc.dateofbirth ||
                          !CheckDoc.documentnumber ||
                          !CheckDoc.documentseries) &&
                        (!CheckDoc.pinfl ||
                          !CheckDoc.documentnumber ||
                          !CheckDoc.documentseries)
                      "
            ...
            <table>
              <tr>
                <td>
                  <b
                    >{{
                      persontypeid == 1 ? $t("studentname") : $t("personname")
                    }}
                    :
                  </b>
                </td>
        ...
        <b-row>
          <b-col class="text-center mt-sm-3 mt-3">
            <b-button
              class="mr-2"
              variant="danger"
...
import KinshipDegreeService from "@/services/KinshipDegree.service";
...
export default {
  ...
  data() {
    return {
      ...
      fieldsPersonDiploms: [
        ...
        {
          key: "degree_name",
          label: this.$t("edudegreename"),
        },
        {
          key: "edu_form_name",
          label: this.$t("educationform"),
        },
        {
          key: "edu_starting_date",
          label: this.$t("startdate"),
        },
        {
          key: "edu_finishing_date",
          label: this.$t("enddate"),
        },
        {
          key: "diploma_given_date",
          label: this.$t("givendate"),
        },
        {
          key: "diploma",
          label: this.$t("diploma"),
        },
        {
          key: "status_name",
          label: this.$t("Status"),
  ...
  methods: {
      ...
      if (!!obj.target.files[0]) {
        if (obj.target.files[0].size < 204800) {
          ...
          FileManageService.Attach(formData)
            .then((res) => {
              this.personPhoto.attachmentfileid = res.data.id;
              this.personPhoto.attachmentfilename = res.data.pfiletext;
              this.personPhoto.attachmentfiletype = res.data.pfiletype;
              this.personPhoto.Status = 1;
              ...
              let text = this.personPhoto.attachmentfilename;
    ...
    ChangeFile1(event) {
      ...
      if (!!event.target.files[0]) {
        if (event.target.files[0].size < 4194304) {
          ...
          FileManageService.Attach(formData)
            .then((res) => {
              this.person.AttachedFiles.push({
                id: 0,
                ownerid: 0,
    ...
    savePersonPhoto() {
      this.DownloadLoading = this.personPhoto.attachmentfileid;
      FileManageService.Get(this.personPhoto.attachmentfileid, 1)
        .then((res) => {
          this.DownloadLoading = "";
          this.forceFileDownload(res, this.personPhoto.attachmentfilename);
        })
        .catch((error) => {
          this.DownloadLoading = "";
          this.makeToast(error.response.data.error, this.$t("error"), "danger");
    ...
    BindValueRealitiva(value) {
      this.relative.dateofbirth = value;
    },
    DeleteFile(item, index) {
      ...
      if (item.Status == 1) {
        this.person.AttachedFiles.splice(index, 1);
      } else {
        this.person.AttachedFiles.forEach(function (item) {
    ...
    CheckDocument() {
      if (this.CheckDoc.pinfl === undefined) {
        this.CheckDoc.pinfl = null;
      }
    ...
    SearchByPinflRelative() {
      var self = this;
      self.pinflRelativeLoading = true;
      PersonService.GetFromGovData(
        self.relative.docseries,
        self.relative.docnumber,
        self.relative.pinfl,
        self.relative.dateofbirth,
        self.persontypeid,
        self.relative.inn,
        self.relative.identitydocumentid
      )
        .then((res) => { 
          // this.relativetabrow = {
          //   Status : 1,
          ...
          // }
          // self.relativetabrow = res.data;

          self.relativetabrow = {
            ...res.data,
            regionid: res.data.liveregionid,
            countryid: res.data.livecountryid,
            oblastid: res.data.liveoblastid,
            regionid: res.data.liveregionid,
            mfyid: res.data.livemfyid,
            hasdied: false,
            address: "",
            identitydocumentid: res.data.DocumentTables[0].identitydocumentid,
            documentseries: res.data.DocumentTables[0].documentseries,
            documentnumber: res.data.DocumentTables[0].documentnumber,
            dateofissue: res.data.DocumentTables[0].dateofissue,
            dateofexpire: res.data.DocumentTables[0].dateofexpire,
            issueorganization: res.data.DocumentTables[0].issueorganization,
            Status: 1,
            id: 0,
          };
          self.getRelativeRegionList();
          self.getRelativeMfyList();
          self.pinflRelativeLoading = false;          
        })
        .catch((error) => {
          self.pinflRelativeLoading = false;
          self.makeToast(error.response.data.error, this.$t("error"), "danger");
        });
    },
    getCountryHigherEdu() {
    ...
    disabledDateOfBirth(date) {
      var today = new Date();
      return (
        date.getFullYear() > today.getFullYear() - 6 ||
    ...
    AddHigherEdu() {
      ...
      self.personhigheredutabrow.highereduclassifiername =
    ...
    HighereducChange() {
      this.personhigheredutabrow.highereduclassifiername =
        this.HigherEduClassifierList.filter(
    ...
    AddPersonPlaceWork() {
      ...
      self.personofworktabrow.employmenttypename =
        self.employmenttypelist.filter(
    ...
    loaddata() {
      ...
      if (this.showSaveButton) {
        PersonService.Get(
          ...
          this.filter.docseries = res.data.DocumentTables[0].documentseries;
          this.filter.docnumber = res.data.DocumentTables[0].documentnumber;
          this.filter.dateofbirth = res.data.dateofbirth;
          if (res.data.PersonPhoto != null) {
            this.personPhoto = res.data.PersonPhoto;
          }
    ...
    filteridentitydocumentchange(row) {
      ...
      this.relative = {
        identitydocumentid: row.identitydocumentid,
        docseries: "",
        docnumber: "",
        inn: "",
        pinfl: "",
    ...
    SearchByPinfl() {
      var self = this;
      if (this.filteridentitydocserieslist.length === 0) {
        this.filter.docseries = this.filter.docseries.toUpperCase();
      }
      ...
      PersonService.GetFromGovData(
        ...
        .then((res) => {
          ...
          if (res.data.PersonPhoto != null) {
            self.personPhoto = res.data.PersonPhoto;
          }
    ...
    SearchByPinflPhoto() {
      ...
      PersonService.GetFromGovData(
        ...
        .then((res) => {
          ...
          self.person = res.data;
          self.personPhoto = res.data.PersonPhoto;
          self.UpdateFromEGovLoading = false;
          self.makeToast(
            self.$t("SuccessUpdate"),
            self.$t("message"),
            "success"
          );
          self.isNotCameData(res.data);
    ...
    BindValue1(value) {
      this.documenttabrow.dateofissue = value;
    },
    AddItemDocument() {
      var self = this;
      ...
      if (
        self.documenttabrow.identitydocumentid !== 4 ||
        self.documenttabrow.identitydocumentid !== 6
      ) {
        if (
        ...
        if (
          !/^[A-Z,a-z,-]/.test(self.documenttabrow.documentseries) &&
          self.filter.identitydocumentid !== 4
        ) {
          this.makeToast(
    ...
    async EditItemRelativeTables(item) {
      this.relativetabrow = {
        id: item.id,
      ...
      this.getRelativeRegionList();

      await this.getRelativeMfyList();
      this.$bvModal.show("AddModal");
    },
    DeleteItem(item) {
      item.Status = 3;
    },
    DeleteItemRelativeTables(item) {
      item.Status = 3;
    },
    AddItemLivePlaces() {
      var self = this;
      ...
      if (!self.relativetabrow.hasdied) {
    ...
    AddItemRelative() {
      ...
      if (self.relativetabrow.hasdied === false) {
        if (
          !/^[A-Z,a-z,-]/.test(self.relativetabrow.documentseries) &&
          self.filter.identitydocumentid !== 4
        ) {
          this.makeToast(
            this.$t("documentseriesNotA-Z"),
      ...
      self.relativetabrow.countryname = self.CountryList.filter(function (
        item
      ) {
      ...
      if (self.relativetabrow.id === 0) {
        ...
        self.person.PersonRelativeTables.forEach(function (item) {
          if (
            ...
            item.id === 0 &&
            !(
              self.relativetabrow.kinshipdegreeid == 10 ||
              self.relativetabrow.kinshipdegreeid == 11
            )
          ) {
            item.ondate = self.relativetabrow.ondate;
          ...
          console.log(self.person.PersonRelativeTables);
        });
        if (addnewrow) {
    ...
    UpdateExperienceTable() {
      PersonService.UpdateExperienceFromMinTrud(
        this.person.id,
        this.person.pinfl
      )
        .then((res) => {
          this.person.PersonExperienceTables = res.data.result;
        })
        .catch((error) => {
          this.makeToast(
            error.response.data.error,
    ...
    UpdatePersonDiploms() {
      PersonService.UpdateDiplomFromMinVuz(this.person.id, this.person.pinfl)
        .then((res) => {
          this.person.PersonDiploms = res.data.result;
        })
        .catch((error) => {
          this.makeToast(
            error.response.data.error,
    ...
    check() {
      ...
      if (
        self.filter.identitydocumentid == 4 &&
        self.person.AttachedFiles.length == 0
      ) {
        this.makeToast(this.$t("notImportFile"), this.$t("Error"), "danger");
        return false;
      }
      if (
      ...
      if (
        self.personPhoto.attachmentfileid === 0 ||
        self.personPhoto.attachmentfileid === null ||
        self.personPhoto.attachmentfileid === undefined ||
        self.personPhoto.attachmentfileid === ""
      ) {
        this.makeToast(
      ...
      if (
        self.person.LivePlaceTables.length === 0 &&
        self.filter.identitydocumentid !== 6
      ) {
        this.makeToast(
    ...
    SaveData() {
      ...
      if (!!this.person.contactinfo && this.person.contactinfo.length == 12) {
        this.person.contactinfo = "+998-" + this.person.contactinfo;
      }
      this.SaveLoading = true;
      this.person.persontypeid = this.persontypeid;
      this.person.PersonPhoto = this.personPhoto;
      PersonService.Update(this.person)
        .then((res) => {
          ...
          if (this.showBackButton) {
            this.$router.push({
              name: this.persontypeid == 1 ? "Student" : "Employee",
              query: {
    ...
    getRelativeMfyList() {
      this.MfyLoading = true;
      MfyService.GetAll(this.relativetabrow.regionid).then((res) => {
        this.MfyLoading = false;

        this.RelativeMfyList = res.data;
      });
    },
  },
