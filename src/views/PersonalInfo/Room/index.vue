  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("Room") }}</h3>
        <CCardHeader>
        ...
        <CCardBody>
          ...
          >
            ...
            <template v-slot:head(roomtype)>
              <div
                class="text-center"
                style="cursor : pointer"
                @click="ChangeSort('roomtype')"
              >
                {{ $t("roomtype") }}
                <b-icon v-if="filter.SortColumn === 'roomtype'" :icon="filter.SortIcon"></b-icon>
              </div>
            </template>
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <b-link
                  v-if="$can('RoomDelete', 'permissions')"
