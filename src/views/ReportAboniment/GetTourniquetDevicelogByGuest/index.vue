      ...
      <CCard accent-color="primary">
        <b-row class="mt-3 mx-1">
          ...
          <b-col class="text-center">
            <h3>{{ $t("GetTourniquetDevicelogByGuest") }}</h3>
          </b-col>
          <b-col md="2">
            <CButton
              @click="Print"
          ...
          >
            ...
            <b-tbody v-if="!Loading">
              ...
              >
                ...
                <b-td class="text-left">{{ item.guestname }}</b-td>
                <b-td class="text-left">{{ item.receivername }}</b-td>
                <!-- <b-td class="text-left">{{ item.circlesporttypename }}</b-td> -->
...
export default {
  ...
  methods: {
    Refresh() {
      this.Loading = true;
      this.isBusy = true;
      SportCircleReportService.GetTourniquetEnteranceListByGuest(
        this.filter.onDate,
        this.filter.endDate,
        this.filter.oblastId,
        this.filter.regionId,
     ...
     Print() {
        ...
        SportCircleReportService.PrintTourniquetEnteranceListByGuest(
        this.filter.onDate,
        this.filter.endDate,
        this.filter.oblastId,
        this.filter.regionId,
        ...
        this.filter.OrderType,
          ...
          .then((res) => {
            (this.PrintLoading = false),
              this.forceFileDownload(res, "PrintTourniquetEnteranceListByGuest");
          })
          .catch((error) => {
            this.makeToast(
