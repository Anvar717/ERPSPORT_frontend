  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <div class="card-head mt-3 mx-3">
          <div class="w-100 text-center">
            <h4 class="text-center">
              {{ $t("TourniquetDevicelogByTerritory") }}
            </h4>
            <!-- {{ $t("studentcapacity") }} -->
          </div>
        </div>
            ...
            <table class="table table-bordered">
              ...
              <tbody v-if="!Loading">
                ...
                >
                  ...
                  <td>
                    {{
                      $options.filters.currency(item.coachattachedpersoncount, {
                        symbol: "",
                        fractionCount: 0,
                      })
                    }}
                  ...
                  <td>
                    {{
                      $options.filters.currency(item.severalchildrenpersoncount, {
                        symbol: "",
                        fractionCount: 0,
                      })
                    }}
                  ...
                  <td>
                    {{
                      $options.filters.currency(
                        item.privilegereasonpersoncount1,
                        {
                          symbol: "",
                          fractionCount: 0,
                        }
                  ...
                  <td>
                    {{
                      $options.filters.currency(
                        item.privilegereasonpersoncount2,
                        {
                          symbol: "",
                          fractionCount: 0,
                        }
                  ...
                  <td>
                    {{
                      $options.filters.currency(
                        item.privilegereasonpersoncount3,
                        {
                          symbol: "",
                          fractionCount: 0,
                        }
              ...
              <tfoot>
                ...
                >
                  ...
                  <td style="white-space: nowrap">
                    {{
                      bottomrow.coachattachedpersoncount == 0
                        ? "-"
                        : $options.filters.currency(
                            bottomrow.coachattachedpersoncount,
                            {
                              symbol: "",
                              fractionCount: 0,
                            }
                  ...
                  <td style="white-space: nowrap">
                    {{
                      bottomrow.severalchildrenpersoncount == 0
                        ? "-"
                        : $options.filters.currency(
                            bottomrow.severalchildrenpersoncount,
                            {
                              symbol: "",
                              fractionCount: 0,
                            }
                  ...
                  <td style="white-space: nowrap">
                    {{
                      bottomrow.privilegereasonpersoncount1 == 0
                        ? "-"
                        : $options.filters.currency(
                            bottomrow.privilegereasonpersoncount1,
                            {
                              symbol: "",
                              fractionCount: 0,
                            }
                  ...
                  <td style="white-space: nowrap">
                    {{
                      bottomrow.privilegereasonpersoncount2 == 0
                        ? "-"
                        : $options.filters.currency(
                            bottomrow.privilegereasonpersoncount2,
                            {
                              symbol: "",
                              fractionCount: 0,
                            }
                  ...
                  <td style="white-space: nowrap">
                    {{
                      bottomrow.privilegereasonpersoncount3 == 0
                        ? "-"
                        : $options.filters.currency(
                            bottomrow.privilegereasonpersoncount3,
                            {
                              symbol: "",
                              fractionCount: 0,
                            }
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.Loading = true;
      SportCircleReportService.GetTourniquetDevicelogByTerritory(
        this.filter.oblastid,
        this.filter.regionid,
        this.filter.ondate
      ).then((res) => {
    ...
    calculateTotal(item) {
      var personcount = 0;
      var coachattachedpersoncount = 0;
      var severalchildrenpersoncount = 0;
      var privilegereasonpersoncount1 = 0;
      var privilegereasonpersoncount2 = 0;
      var privilegereasonpersoncount3 = 0;
      item.forEach(function (item) {
        personcount = personcount + item.personcount;
        coachattachedpersoncount =
          coachattachedpersoncount + item.coachattachedpersoncount;
        severalchildrenpersoncount =
          severalchildrenpersoncount + item.severalchildrenpersoncount;
        privilegereasonpersoncount1 =
          privilegereasonpersoncount1 + item.privilegereasonpersoncount1;
        privilegereasonpersoncount2 =
          privilegereasonpersoncount2 + item.privilegereasonpersoncount2;
        privilegereasonpersoncount3 =
          privilegereasonpersoncount3 + item.privilegereasonpersoncount3;
      });
      this.bottomrow = {
        personcount: personcount,
        coachattachedpersoncount: coachattachedpersoncount,
        severalchildrenpersoncount: severalchildrenpersoncount,
        privilegereasonpersoncount1: privilegereasonpersoncount1,
        privilegereasonpersoncount2: privilegereasonpersoncount2,
        privilegereasonpersoncount3: privilegereasonpersoncount3,
      };
    },
