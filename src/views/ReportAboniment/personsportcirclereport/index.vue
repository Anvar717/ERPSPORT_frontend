      ...
      <CCard accent-color="primary">
        <b-row class="mt-3 mx-1">
          ...
          <b-col class="text-center">
            <h3>{{ $t("PersonSportCircleReport") }}</h3>
          </b-col>
          <b-col md="2">
            <CButton
              @click="Print"
          ...
          <!-- <CRow class="form-group">
            <CCol>
              <h4 class="region-text">
                ...
                <a href="javascript:void(0)" class="text-sm-center">{{
                  filter.RegionName
                }}</a>
              </h4>
            </CCol>
          ...
          >
            ...
            <b-tbody v-if="!Loading">
              ...
              >
                ...
                <b-td class="text-left">{{ item.positionname }}</b-td>
...
export default {
  ...
  methods: {
    Refresh() {
      this.Loading = true;
      this.isBusy = true;
      SportCircleReportService.GetTourniquetEnteranceListByEmployee(
        this.filter.onDate,
        this.filter.endDate,
        this.filter.oblastId,
        this.filter.regionId,
    ...
    Print() {
      (this.PrintLoading = true),
        SportCircleReportService.PrintTourniquetEnteranceListByEmployee(
          this.filter.onDate,
          this.filter.endDate,
          this.filter.oblastId,
          this.filter.regionId,
          ...
          .then((res) => {
            (this.PrintLoading = false),
              this.forceFileDownload(res, "PrintTourniquetEnteranceListByEmployee");
          })
          .catch((error) => {
            this.makeToast(
