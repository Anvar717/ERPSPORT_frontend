...
export default {
  ...
  methods: {
    Refresh() {
      this.Loading = true;
      this.isBusy = true;
      SportCircleReportService.GetTourniquetEnteranceListByMembership(
        this.filter.onDate,
        this.filter.endDate,
        this.filter.oblastId,
        this.filter.regionId,
     ...
     Print() {
      (this.PrintLoading = true),
        SportCircleReportService.PrintTourniquetEnteranceListByMembership(
          this.filter.oblastId,
          this.filter.regionId,
          this.filter.onDate,
          this.filter.endDate,
          ...
          .then((res) => {
            (this.PrintLoading = false),
              this.forceFileDownload(res, "PrintTourniquetEnteranceListByMembership");
          })
          .catch((error) => {
            this.makeToast(
