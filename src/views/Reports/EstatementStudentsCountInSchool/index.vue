    ...
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <b-row class="mt-3 mx-1">
          <b-col>
            <h3 class="text-center">{{ $t("EstatementStudentsCountInSchool") }}</h3>
          </b-col>
        </b-row>

        <CCardHeader>
          <CRow class="form-group" md="12" sm="12"
          >
...
export default {
  ...
  methods: {
    ...
    Print() {
      ...
      ReportLearningProcessService.PrintEstatementStudentsCountInSchool(
        this.filter.schoolyearid,
    ...
    Refresh() {
      this.isBusy = true;
      ReportLearningProcessService.EstatementStudentsCountInSchool(
        ...
        if (res.data.oblastid > 0) this.ChangeOblast();
        this.filter.regionid = res.data.regionid;
        if (res.data.regionid > 0) this.ChangeRegion();
