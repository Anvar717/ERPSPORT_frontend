  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("SentSportOrgRating") }}</h3>
        <CCardHeader>
          <b-row class="mx-0 mb-3">
            <b-col sm="12" md="12" lg="12">
              <div class="d-flex">
                ...
                <div class="mr-2" style="width: 30%; margin-top: 28px;">
                  <CButton
                    @click="Refresh"
                    size="sm"
                    color="primary"
                ...
                <div class="mr-2 mt-3" style="width: 30%">
                  <CButton
                    color="danger"
          ...
          >
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                ...
                <!-- <b-dropdown variant="link" no-caret class="ml-n2 px-0" v-if="item.statusid != 9">
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      SportOrgRatingService.GetSendList(
        this.filter.Search,
        this.filter.oblastid,
        this.filter.regionid,
        this.filter.organizationid,
        ...
        if (res.data.oblastid > 0) this.filter.oblastid = res.data.oblastid;
        if (!!this.filter.oblastid) {
          RegionService.GetAll(this.lang, this.filter.oblastid).then((res) => {
            this.RegionList = res.data;
          });
