    ...
    <CCol>
      <CCard accent-color="primary" class="pb-4">
        <CCardHeader>
          ...
          {{ $t("SentSportOrgRating") }}
          <div class="card-header-actions">
            <CLink
              href="#"
              class="card-header-action btn-close"
              v-on:click="$router.push({ name: 'SentSportOrgRating' })"
            >
        ...
        <b-row>
          ...
          <b-col sm="12" md="2" lg="2" class="mt-2">
            <b-button
              ...
              size="sm"
              variant="danger"
              class="w-100 mb-1 mr-4"
            >
              <b-icon-arrow-left-short scale="1.7" />
              {{ $t("back") }}
            </b-button>
            <b-button
              v-if="SportOrgRating.CanAccept"
          ...
          <b-modal :ref="'ApproveModal'" no-close-on-backdrop hide-footer>
            ...
            <b-card-text class="mt-3">
              ...
              <span>
                <h5>
                  {{ $t("docnumber") }} : {{ SportOrgRating.docnumber }}
                </h5></span
              >
              <h5>{{ $t("WantApprove") }}</h5>
            </b-card-text>
...
export default {
  ...
  methods: {
    ...
    Approve() {
      ...
      SportOrgRatingService.Accept(this.SportOrgRating.id)
        .then((res) => {
    ...
    CancelApproval() {
      if (
        this.CancelApproveData.returnReason === null ||
        this.CancelApproveData.returnReason === undefined ||
        this.CancelApproveData.returnReason === 0 ||
        this.CancelApproveData.returnReason === ""
      ) {
        this.makeToast(
          this.$t("reasonNotCorrect"),
          this.$t("Error"),
          "danger"
        );
        return false;
      ...
      SportOrgRatingService.Reject(
        this.SportOrgRating.id,
        this.CancelApproveData.returnReason
      )
        .then((res) => {
    ...
    Back() {
      this.$router.push({ name: "SentSportOrgRating" });
    },
    ...
    checktabrowdata() {
      var self = this;
      if (
        self.CancelApproveData.returnReason === null ||
        self.CancelApproveData.returnReason === undefined ||
        self.CancelApproveData.returnReason === 0 ||
        self.CancelApproveData.returnReason === ""
      ) {
        self.makeToast(
          self.$t("reasonNotCorrect"),
          self.$t("Error"),
          "danger"
        );
        return false;
      ...
      if (self.selected.length == 0) {
        this.makeToast(this.$t("ItemNotSelected"), this.$t("Error"), "danger");
