  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("Appeal") }}</h3>
        <CCardHeader>
          ...
          >
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                <b-link
                  v-if="$can('AppealEdit', 'permissions') && item.statusid != 2"
                  @click="Edit(item)"
                  class="mr-2"
                ...
                <b-link
                  v-if="
                    $can('AppealDelete', 'permissions') && item.statusid != 2
                  "
                ...
                <b-dropdown variant="link" no-caret class="ml-n2 px-0">
                  ...
                  <div>
                    ...
                    <b-dropdown-item
                      v-if="
                        $can('AppealCancelApproval', 'permissions') &&
                        item.statusid != 3 &&
                        item.statusid != 1
                      "
                    ...
                    <b-dropdown-item
                      v-if="item.statusid != 1 && item.statusid != 8"
...
export default {
  ...
  methods: {
    ...
    CancelApproval(item) {
      var self = this;
      AppealService.CancelApproval(item.id)
        .then((res) => {
          self.makeToast(
