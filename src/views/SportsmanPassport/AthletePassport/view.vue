    ...
    <b-card>
      ...
      <b-row class="mt-3">
            ...
            <table>
              <tbody>
                ...
                <tr>
                  ...
                  <td class="font-weight-bold pb-1">
                    {{ person.birthoblastname }}
                  </td>
                </tr>
                <tr>
                  <td class="pr-1 pb-1">{{ $t("regionname") }} :</td>
                  <td class="font-weight-bold pb-1">
                    {{ person.birthregionname }}
                  </td>
                </tr>
                <tr>
                  <td>
        ...
        <b-col cols="12" md="2">
          ...
          <!-- <b-button
            v-if="AthletePassport.CanAccept"
          ...
          <!-- <b-button
            v-if="AthletePassport.CanReject"
  ...
  created() {
    ...
    AthletePassportService.Get(this.$route.params.id)
      .then((res) => {
        ...
        this.AthletePassport.Person.PersonPhoto = res.data.Person.PersonPhoto;
        this.show = false;
      })
      .catch((error) => {
    ...
    AthletePassportSeriesService.GetAll(0).then((res) => {
