<template>
    <CRow>
      <CCol sm="12" md="12">
        <CCard accent-color="primary">
          <h3 class="text-center mt-3">{{ $t("CompetitionLevel") }}</h3>
          <CCardHeader>
              ...
              <template v-slot:cell(actions)="{ item }">
                ...
                <b-modal :id="'DeleteModal' + item.id" hide-footer>
                  ...
                  <div class="d-block text-right">
                    ...
                    <CButton
                    v-if="$can('CompetitionTypeDelete', 'permissions')"
  ...
  export default {
    ...
    methods: {
      ...
      Delete(item) {
        CompetitionLevelService.Delete(item.id)
          .then((res) => {
            this.makeToast(
      ...
      Refresh() {
        this.isBusy = true;
        CompetitionLevelService.GetList(
          this.filter.Search,
