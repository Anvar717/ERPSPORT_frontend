<template>
      ...
      <CCol>
        <CCard accent-color="primary" class="pb-4">
          <CCardHeader>
            <CRow>
              <CCol>
                <h4 class="text-center">{{ $t("SportEventCategory") }}</h4>
              </CCol>
            </CRow>
          </CCardHeader>
          <CCardBody>
            <CRow>
              ...
              <CCol sm="6">
                ...
                type="number"
                  ...
                  horizontal
                  :label="$t('code1')"
                  v-model="SportEventCategory.code"
                ></CInput>
              </CCol>
              <CCol sm="3"></CCol>
            </CRow>
            <CRow>
              ...
              <CCol sm="6">
                <CInput
                  ...
                  horizontal
                  :label="$t('shortname')"
                  v-model="SportEventCategory.shortname"
                >
                  <template #append>
                    <CButton
                      @click="ShortNameLang"
            ...
            <CRow>
              ...
              <CCol sm="6">
                <CInput
                  ...
                  horizontal
                  :label="$t('fullname')"
                  v-model="SportEventCategory.fullname"
                >
                  <template #append>
                    <CButton
                      @click="FullNameLang"
              ...
              <CCol sm="6">
                <div class="form-group form-row">
                  ...
                  <v-select
                    class="col-sm-9"
                    :options="statelist"
                    v-model="SportEventCategory.stateid"
                    :reduce="(item) => item.id"
              ...
              <CCol>
                <div class="text-left">
                  <CButton
                    ...
                    size="sm"
                    color="danger"
                    @click="$router.push({ name: 'SportEventCategory' })"
                  >
  ...
  export default {
    ...
    created() {
      ...
      SportEventCategoryService.Get(this.$route.params.id).then((res) => {
        this.SportEventCategory = res.data;
        this.items1 =
    ...
    methods: {
      check() {
        ...
        if (
          self.SportEventCategory.code === 0 ||
          self.SportEventCategory.code === null ||
          self.SportEventCategory.code === undefined ||
          self.SportEventCategory.code === ""
        ) {
          this.makeToast(this.$t("codeNotCorrect"), this.$t("Error"), "danger");
          return false;
        }
        if (
          self.SportEventCategory.shortname === 0 ||
          self.SportEventCategory.shortname === null ||
          self.SportEventCategory.shortname === undefined ||
          self.SportEventCategory.shortname === ""
        ) {
          this.makeToast(
        ...
        if (
          self.SportEventCategory.fullname === 0 ||
          self.SportEventCategory.fullname === null ||
          self.SportEventCategory.fullname === undefined ||
          self.SportEventCategory.fullname === ""
        ) {
          this.makeToast(
        ...
        if (
          self.SportEventCategory.stateid === 0 ||
          self.SportEventCategory.stateid === null ||
          self.SportEventCategory.stateid === undefined ||
          self.SportEventCategory.stateid === ""
        ) {
      ...
      SaveData() {
        ...
        SportEventCategoryService.Update(this.SportEventCategory)
          .then((res) => {
            this.makeToast(
            ...
            this.$router.push({ name: "SportEventCategory" });
          })
          .catch((error) => {
            this.makeToast(
