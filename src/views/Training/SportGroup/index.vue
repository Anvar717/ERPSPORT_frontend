  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("SportGroup") }}</h3>
        <CCardHeader>
          ...
          >
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                <b-link
                  v-if="$can('SportGroupEdit', 'permissions')"
                  @click="Edit(item)"
                  class="mr-2"
                ...
                <b-link
                  v-if="$can('SportGroupDelete', 'permissions')"
...
export default {
  data() {
    return {
      fields: [
        ...
        {
          key: "sportlevelname",
          label: this.$t("SportLevel"),
          sortable: false,
          thClass: "text-center",
          tdClass : "text-left"
        },
        {
          key: "sportgroupnumber",
          label: this.$t("sportgroupnumber"),
          sortable: false,
          thClass: "text-center",
          tdClass : "text-center"
        },
  ...
  methods: {
    ...
    Delete(item) {
      SportGroupService.Delete(item.id)
        .then((res) => {
          this.makeToast(
