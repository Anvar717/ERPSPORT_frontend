  ...
  <CRow>
    <CCol sm="12" md="12">
      <CCard accent-color="primary">
        <h3 class="text-center mt-3">{{ $t("SportTypeClassifier") }}</h3>
        <CCardHeader>
          <CRow class="form-group justify-content-between">
            ...
            <CCol lg="7" md="6" sm="12" class="text-lg-right mt-2" style="margin-right: -7px;">
              <CButton
                v-if="$can('SportTypeClassifierDelete', 'permissions')"
                @click="Create"
                color="primary"
                variant="outline"
                class="mr-2"
          ...
          >
            ...
            <template v-slot:cell(actions)="{ item }">
              <div class="text-center">
                <b-link
                  v-if="$can('SportTypeClassifierEdit', 'permissions')"
                  @click="Edit(item)"
                  class="mr-2"
...
export default {
  data() {
    return {
      fields: [
        ...
        {
          key: "sportgrowthratename",
          label: this.$t("SportGrowthRate"),
          sortable: false,
          thClass: "text-center",
          tdClass: "text-left",
        },
        {
          key: "sporttypedependencename",
          label: this.$t("SportTypeDependence"),
          sortable: false,
          thClass: "text-center",
          tdClass: "text-left",
        },
        {
          key: "sporttyperestrictionname",
          label: this.$t("SportTypeRestriction"),
          sortable: false,
          thClass: "text-center",
          tdClass: "text-left",
        },
        {
          key: "sporttypegendername",
          label: this.$t("SportTypeGender"),
          sortable: false,
          thClass: "text-center",
          tdClass: "text-left",
        },
        {
          key: "sporttypedivisionname",
          label: this.$t("SportTypeDivision"),
          sortable: false,
          thClass: "text-center",
          tdClass: "text-left",
        },
  ...
  methods: {
    ...
    Delete(item) {
      SportTypeClassifierService.Delete(item.id)
        .then((res) => {
          this.makeToast(
    ...
    Refresh() {
      this.isBusy = true;
      SportTypeClassifierService.GetList(
        this.filter.Search,
