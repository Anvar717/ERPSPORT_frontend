    ...
    <CCol>
      <CCard accent-color="primary" class="pb-4">
        <CCardHeader>
          <CRow>
            <CCol>
              <h4 class="text-center">{{ $t("SportTypeDivision") }}</h4>
            </CCol>
          </CRow>
        </CCardHeader>
        <CCardBody>
          <CRow>
            ...
            <CCol sm="6">
              ...
              type="number"
                ...
                horizontal
                :label="$t('code1')"
                v-model="SportTypeDivision.code"
              ></CInput>
            </CCol>
            <CCol sm="3"></CCol>
          </CRow>
          <CRow>
            ...
            <CCol sm="6">
              <CInput
                ...
                horizontal
                :label="$t('shortname')"
                v-model="SportTypeDivision.shortname"
              >
                <template #append>
                  <CButton
                    @click="ShortNameLang"
          ...
          <CRow>
            ...
            <CCol sm="6">
              <CInput
                ...
                horizontal
                :label="$t('fullname')"
                v-model="SportTypeDivision.fullname"
              >
                <template #append>
                  <CButton
                    @click="FullNameLang"
            ...
            <CCol sm="6">
              <div class="form-group form-row">
                ...
                <v-select
                  class="col-sm-9"
                  :options="genderlist"
                  v-model="SportTypeDivision.genderid"
                  :reduce="item => item.id"
            ...
            <CCol sm="6">
              <div class="form-group form-row">
                ...
                <v-select
                  class="col-sm-9"
                  :options="statelist"
                  v-model="SportTypeDivision.stateid"
                  :reduce="(item) => item.id"
                  :placeholder="$t('ChooseBelow')"
                  label="name"
                ></v-select>
            ...
            <CCol>
              <div class="text-left">
                <CButton
                  ...
                  size="sm"
                  color="danger"
                  @click="$router.push({ name: 'SportTypeDivision' })"
                >
...
export default {
  ...
  created() {
    ...
    SportTypeDivisionService.Get(this.$route.params.id).then((res) => {
      this.SportTypeDivision = res.data;
      this.items1 =
  ...
  methods: {
    check() {
      ...
      if (
        self.SportTypeDivision.code === 0 ||
        self.SportTypeDivision.code === null ||
        self.SportTypeDivision.code === undefined ||
        self.SportTypeDivision.code === ""
      ) {
        this.makeToast(this.$t("codeNotCorrect"), this.$t("Error"), "danger");
        return false;
      }
      if (
        self.SportTypeDivision.shortname === 0 ||
        self.SportTypeDivision.shortname === null ||
        self.SportTypeDivision.shortname === undefined ||
        self.SportTypeDivision.shortname === ""
      ) {
        this.makeToast(
      ...
      if (
        self.SportTypeDivision.fullname === 0 ||
        self.SportTypeDivision.fullname === null ||
        self.SportTypeDivision.fullname === undefined ||
        self.SportTypeDivision.fullname === ""
      ) {
        this.makeToast(
      ...
      if (
        self.SportTypeDivision.stateid === 0 ||
        self.SportTypeDivision.stateid === null ||
        self.SportTypeDivision.stateid === undefined ||
        self.SportTypeDivision.stateid === ""
      ) {
    ...
    SaveData() {
      ...
      SportTypeDivisionService.Update(this.SportTypeDivision)
        .then((res) => {
          this.makeToast(
          ...
          this.$router.push({ name: "SportTypeDivision" });
        })
        .catch((error) => {
          this.makeToast(
    ...
    AddItem() {
      if (this.TranslatebyName == "shortname") {
        this.ItemsPush();
        this.SportTypeDivisionTranslatePush();
    ...
    SportTypeDivisionTranslatePush() {
      this.SportTypeDivision.Translates.push({
        languageid: this.Translate.languageid,
        languagename: this.LanguageList.filter(
          (item) => item.id == this.Translate.languageid
        )[0].name,
